...
$departmentId = isset($_GET['departamento_id']) ? $_GET['departamento_id'] : null;

if ($departmentId !== null) {
    $provincias = array_filter($ubigeo_peru_provinces, function ($provincia) use ($departmentId) {
        return $provincia['department_id'] === $departmentId;
    });
